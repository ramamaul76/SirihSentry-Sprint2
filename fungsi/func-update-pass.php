...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($reenter_password === $new_password) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo '<script>alert("Password berhasil di ganti."); window.location.href = "../users-profile.php";</script>';
        } else {
        ...
        echo '<script>alert("Password yang dimasukkan tidak cocok. Silakan coba lagi."); window.history.back();</script>';
    }
}
