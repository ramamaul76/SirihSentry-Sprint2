...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE user SET name='$name', about='$about', job='$job', country='$country', address='$address', phone='$phone' WHERE id='$user_id'";

    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Data profil berhasil di update."); window.location.href = "../users-profile.php";</script>';
    } else {
